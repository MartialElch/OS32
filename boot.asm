...
go_pm:
    ...
    mov ss, ax
    mov es, ax
    mov esp, 0x9000         ; stack begins at 0x9000
...
;--------------------
    times 510-($-$$) db 0    ; write signature at end so this
    db 0x55                  ; is recognized as bootable
    db 0xAA
